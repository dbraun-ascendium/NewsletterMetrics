(() => {
          ...
          this.parse = function(i, t, r2) {
            ...
            if (j.header) {
              ...
              for (var _2 in l2) {
                ...
                0 < v2 && (g2 = true, y2 = m2 + "_" + v2), p2[m2] = v2 + 1, c2.push(y2);
              }
              if (g2) {
                var k = i.split(P);
  ...
  var csvToObject = (file) => new Promise((resolve) => {
  ...
  var handleFiles = function(files, process2) {
    if (files.length !== 3) {
  ...
  var endDateLastMonthLastYear = new Date(endDateLastMonth);
  ...
  var countSnapshotYearAgo = function(data) {
    ...
    data.cleaned.forEach((cleaned) => {
      ...
      const cleanTime = new Date(cleaned.CLEAN_TIME);
      if (cleanTime > endDateLastMonthLastYear && confTime < endDateLastMonthLastYear) {
    ...
    data.unsubbed.forEach((unsubbed) => {
      ...
      const unsubTime = new Date(unsubbed.UNSUB_TIME);
      if (unsubTime > endDateLastMonthLastYear && confTime < endDateLastMonthLastYear) {
